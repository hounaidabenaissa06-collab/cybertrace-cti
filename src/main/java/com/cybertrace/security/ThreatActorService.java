...
public class ThreatActorService {
    ...
    // Compteur atomique thread-safe pour générer des IDs strictement uniques.
    // Remplace System.currentTimeMillis(), qui pouvait produire des doublons
    // quand deux acteurs étaient créés dans la même milliseconde.
    ...
    public ThreatActor createActor(String type, String name,
        ...
        String id = "TA-" + idCounter.incrementAndGet();
